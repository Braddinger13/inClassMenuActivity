...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.action_take_picture -> Toast.makeText(this, "Take Picture Clicked", Toast.LENGTH_SHORT).show()
            ...
            R.id.action_delete_picture -> {
                android.app.AlertDialog.Builder(this)
                    .setTitle("Delete onfirmation")
                    .setMessage("Are you sure you want to delete this picture, this can't be undone")
